...
const mockRawFeedback = {
  ...
  rawContent:
    'O sistema WMS do CD01 parou de funcionar, caminhões parados na doca aguardando conferência',
  attachments: null,
...
const mockClaudeResponse = {
  ...
  severityScore: 9.5,
  summary:
    'WMS do CD01 fora de operação, caminhões parados na doca aguardando conferência',
  ...
  it('should set reclassified=true when reclassificationReason is present', async () => {
    const withReclassification = {
      ...
      reclassificationReason:
        'Não se encaixa claramente, mais próximo de GM_LOG',
    };
    mockCreate.mockResolvedValue({
